...
DEFAULT_PERMISSION_RULES: list[PermissionRule] = [
    ...
    PermissionRule(
        ...
        pattern="*",
        action="allow",
        reason="workspace edits are allowed in build mode",
    ),
    PermissionRule(
        category="bash",
        pattern="*",
        action="ask",
        reason="non-read-only shell commands require approval",
    ),
    PermissionRule(
        category="bash",
        pattern="git push*",
    ...
    PermissionRule(category="task", pattern="*", action="allow", reason="delegation is allowed"),
    PermissionRule(category="skill", pattern="*", action="allow", reason="skills are allowed"),
    ...
    PermissionRule(
        ...
        pattern="*",
        action="allow",
        reason="web fetches are read-only",
    ),
    PermissionRule(
        category="websearch",
        pattern="*",
        action="allow",
        reason="web searches are read-only",
    ),
    PermissionRule(
        category="question",
        pattern="*",
